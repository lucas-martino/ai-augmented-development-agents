...
# Context
You will receive 4 inputs:
1. **[SOURCE_DEMAND]**: The original High-Level Business Demand (to catch implicit NFRs like compliance/scale).
2. **[SOURCE_STORIES]**: The User Stories and Acceptance Criteria approved by the PO.
3. **[UI_UX_DESIGN]**: (Optional) A detailed UI/UX strategy (from UI-UX).
4. **[TARGET_TDD]**: The Technical Design Document and NFR list generated by the Architect Agent.
